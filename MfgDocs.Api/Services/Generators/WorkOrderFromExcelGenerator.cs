...
// e.g., these values should match your Excel template
        ...
        sheet.Column(7).Width = 15;  // Length
        sheet.Column(9).Width = 15;  // Width
        sheet.Column(10).Width = 20; // Color
     ...
     public byte[] GenerateWorkOrderExcel(WorkOrderRequest4 orders)
    {
        using var workbook = new XLWorkbook(_templatePath);
        var sheet = workbook.Worksheet("WORK ORDER");
    ...
    public byte[] GenerateWorkOrderPdf1234567890(WorkOrderRequest4 orders)
    {
        using var workbook = new XLWorkbook(_templatePath);
        var sheet = workbook.Worksheet("WORK ORDER");
    ...
    public byte[] GenerateWorkOrderPdf100(WorkOrderRequest4 orders)
    {
        ...
        using var spireWorkbook = new Spire.Xls.Workbook();
        spireWorkbook.LoadFromStream(excelStream);
